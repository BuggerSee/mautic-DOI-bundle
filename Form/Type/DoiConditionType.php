...
class DoiConditionType extends AbstractType
{
        ...
        $builder->add(
            ...
            [
                ...
                'attr' => [
                    ...
                    'onchange' => 'Mautic.doiUpdateConditionPositioning(this)',
                ],
            ]
        );
            ...
            $form->add(
                ...
                [
                    ...
                    'attr'    => [
                        ...
                        'onchange' => 'Mautic.doiConvertConditionInput(this)',
                    ],
                ]
            );
    ...
    {
        return 'conditional_doi_action_condition';
    }
}
